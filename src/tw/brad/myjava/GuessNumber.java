...
public class GuessNumber extends JFrame implements ActionListener{
	...
	public GuessNumber() {
		...
		guess.addActionListener(this);       //Listener
...
//		});
	...
	private String createAnswer(int dig) { //如何引用API
		int nums = 10;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (result.equals("3A0B")) {
			JOptionPane.showInternalMessageDialog(null, "恭喜老爺");
			newRound();
		}else if (counter == 10) {
			JOptionPane.showInternalMessageDialog(null, "魯蛇"+ answer);
			newRound();
		}
